...
const Reviews = () => {
  ...
  const [thankYouMessage, setThankYouMessage] = useState(businessSettings?.thank_you_message || 'Thank you for your feedback! We appreciate your time.');
  ...
  useEffect(() => {
    if (businessSettings) {
      setReviewThreshold(businessSettings.review_threshold || 4);
